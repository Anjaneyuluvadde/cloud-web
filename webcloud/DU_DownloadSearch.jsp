...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style1">WEBCLOUD: INTERNET-LINKED CLOUD REPOSITORY <br />
          FOR PROTECTED INFORMATION EXCHANGE ACROSS SYSTEMS</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
    ...
    String user=(String)application.getAttribute("uname");
          ...
          <form action="DU_Download1.jsp" method="post" name="form1" id="form1">
            <table width="473" border="0" align="center">
              <tr>
                <td width="223" bgcolor="#FF0000"><span class="style22 style25"><strong>Enter File Name :-</strong></span></td>
              ...
              <tr>
                <td height="34" bgcolor="#FF0000"><span class="style22 style25"><strong>MAC :-</strong></span></td>
                <td><input name="t12" type="text" size="40" /></td>
              </tr>
              <tr>
                <td bgcolor="#FF0000"><span class="style25 style22"><strong>Secret Key :-</strong></span></td>
              ...
              <tr>
                <td><div align="right">
                    <input type="submit" name="Submit" value="Req MAC" />
                </div></td>
                <td><label>
